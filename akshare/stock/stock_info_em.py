...
if __name__ == "__main__":
    stock_individual_info_em_df = stock_individual_info_em(symbol="515880", timeout=None)
    print(stock_individual_info_em_df)
    stock_individual_info_em_df = stock_individual_info_em(symbol="513130", timeout=None)
    print(stock_individual_info_em_df)
