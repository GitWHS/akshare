...
def stock_sector_fund_flow_hist(code: str = "电源设备") -> pd.DataFrame:
    """
...
def stock_concept_fund_flow_hist(code: str = "锂电池") -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    stock_sector_fund_flow_hist_df = stock_sector_fund_flow_hist(code="BK1042")
    print(stock_sector_fund_flow_hist_df)

    stock_concept_fund_flow_hist_df = stock_concept_fund_flow_hist(code="BK1137")
